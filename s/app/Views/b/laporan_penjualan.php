    ...
    <div class="card card-xxl-stretch mb-5 mb-xl-10">
      <div class="card-header card-header-stretch">
        <div class="card-title">
          <h3 class="m-0 text-gray-900">Laporan Penjualan</h3>
        </div>
            ...
            <div class="tab-pane fade active show" id="tab_laporan_<?=$k?>" role="tabpanel">
              ...
              <div class="pt-2">
                <div class="d-flex align-items-center pb-6 px-9">
                  <!--begin::Title-->
                  <h3 class="m-0 text-gray-900 flex-grow-1">Penjualan <label id="thetitle">Harian</label></h3>
                  <!--end::Title-->
                  <!--begin::Nav pills-->
              ...
              <script>
                ...
                function filtering(){
                  ...
                  $.post('<?=site_url('laporan/penjualan')?>',{toko:toko,type:what}).done(function(data){
                    // omzet
                    updateCountUp('#count_omzet', data.summary.omzet);

                    // lainnya
                    updateCountUp('#count_transaksi', data.summary.transaksi);
                    updateCountUp('#count_item', data.summary.item);
                    updateCountUp('#count_retur', data.summary.retur);
                    updateCountUp('#count_tukar', data.summary.tukar);// GRAPH
                    renderLapGraph(
              ...
              <div class="row p-0 mb-5 px-9">
                <div class="col">
                  <div class="border border-dashed border-gray-300 text-center min-w-125px rounded pt-4 pb-2 my-3">
                    <span class="fs-4 fw-bold text-success d-block">💰 Omzet Penjualan</span>
                    <span class="fs-2hx fw-bolder text-gray-900" id="count_omzet" data-kt-countup-prefix="Rp " data-kt-countup-separator=",">0</span>
                  </div>
                </div>
                <div class="col">
                  <div class="border border-dashed border-gray-300 text-center min-w-125px rounded pt-4 pb-2 my-3">
                ...
                <div class="col">
                  <div class="border border-dashed border-gray-300 text-center min-w-125px rounded pt-4 pb-2 my-3">
                    <span class="fs-4 fw-bold text-primary d-block">📦 Jumlah Item Terjual</span>
                    <span class="fs-2hx fw-bolder text-gray-900" id="count_item" >0</span>
                  </div>
                </div>
                <div class="col">
                  <div class="border border-dashed border-gray-300 text-center min-w-125px rounded pt-4 pb-2 my-3">
                    <span class="fs-4 fw-bold text-danger d-block">🔄 Retur Barang</span>
                    <span class="fs-2hx fw-bolder text-gray-900" id="count_retur" >0</span>
                  </div>
                </div>
                <div class="col">
                  <div class="border border-dashed border-gray-300 text-center min-w-125px rounded pt-4 pb-2 my-3">
                    <span class="fs-4 fw-bold text-warning d-block" style="color:darkorange !important;">🔄 Tukar Barang</span>
                    <span class="fs-2hx fw-bolder text-gray-900" id="count_tukar" >0</span>
                  </div>
                </div>
              </div>
              <!--end::Row-->
  ...
  <div class="card-body">
    <div class="row g-3 align-items-end">
      ...
      <div class="col-md-2">
        ...
        <select id="filterToko" class="form-select form-select-sm">
