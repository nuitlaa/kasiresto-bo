...
<div class="card pt-4 mb-6 mb-xl-9"> 
	...
	<div id="kt_customer_view_payment_method" class="card-body pt-0">
        ...
        <div class="container-fluid">
            ...
            <h3 class="mb-5">📦 Stok Bahan</h3>

            <div class="card">
                <div class="card-body">

                    <table id="table-stock" class="table table-row-dashed align-middle">
                        <thead>
                            <tr>
                                <th>Nama Bahan</th>
                                <th>Stok</th>
        ...
        <script>
            $('#table-stock').DataTable({
                processing: true,
                serverSide: true,
                ajax: '<?= base_url("produk/datastokbahan") ?>',
                order: [[1, 'asc']],
                columns: [
                    { data: 'name' },
                    { 
                        ...
                        render: function(data, type, row){
                            if(row.status_stock === 'danger'){
                                return `<span class="badge badge-light-danger fw-bold">${data}</span>`;
                            }
