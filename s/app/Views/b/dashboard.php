...
<html lang="en">
	...
	<head><base href="">
		...
		<link href="<?=base_url('t/')?>plugins/custom/fullcalendar/fullcalendar.bundle.css" rel="stylesheet" type="text/css" />
			...
			<div class="page launcher sidebar-enabled d-flex flex-row flex-column-fluid me-lg-5" id="kt_page">
									...
									<div class="card border-0 shadow-none h-lg-100" style="background-color: #A838FF">
										<div class="card-body d-flex flex-column flex-center pb-0 pt-15">
											<div class="px-10 mb-10">
												<h3 class="text-white mb-2 fw-boldest ttext-center text-uppercase mb-6">Admin Toko</h3>
												<div class="mb-7">
													<div class="d-flex align-items-center mb-2">
														...
														<span class="text-white opacity-75">Produk</span>
													</div>
													<div class="d-flex align-items-center mb-2">
														<span class="svg-icon svg-icon-4 svg-icon-white opacity-75 me-3">
															<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
														...
														<span class="text-white opacity-75">Pelanggan</span>
													</div>
													<div class="d-flex align-items-center mb-2">
														<span class="svg-icon svg-icon-4 svg-icon-white opacity-75 me-3">
															<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
														...
														<span class="text-white opacity-75">Supplier</span>
													</div>
												</div>
												<a href="<?=site_url('beranda')?>" class="btn btn-hover-rise text-white bg-white bg-opacity-10 text-uppercase fs-7 fw-bolder">Dashboard</a>
											</div>
											<img class="mw-100 h-225px mx-auto mb-lg-n18" src="<?=base_url('t/')?>media/illustrations/sigma-1/12.png" />
										</div>
									</div>
								</div>
								<div class="col-xxl-7">
									<div class="row g-lg-7">
										<div class="col-sm-6">
											<a href="#" onclick="projectmod(); return false;" class="card border-0 shadow-none min-h-200px mb-7" style="background-color: #F9666E">
												<div class="card-body d-flex flex-column flex-center text-center">
													<img class="mw-100 h-100px mb-7 mx-auto" src="<?=base_url('t/')?>media/illustrations/sigma-1/4.png" />
													<h4 class="text-white fw-bolder text-uppercase">Tambah Produk</h4>
												</div>
											</a>
										</div>
										<div class="col-sm-6">
											<a href="#" onclick="pelangganmod(); return false;" class="card border-0 shadow-none min-h-200px mb-7" style="background-color: #35D29A">
												<div class="card-body d-flex flex-column flex-center text-center">
													<img class="mw-100 h-100px mb-7 mx-auto" src="<?=base_url('t/')?>media/illustrations/sigma-1/5.png" />
													<h4 class="text-white fw-bolder text-uppercase">Tambah Pelanggan</h4>
												</div>
											</a>
										</div>
									</div>
									<div class="card border-0 shadow-none min-h-200px" style="background-color: #D5D83D">
										<div class="card-body d-flex flex-center flex-wrap">
											<img class="mw-100 h-200px me-4 mb-5 mb-lg-0" src="<?=base_url('t/')?>media/illustrations/sigma-1/11.png" />
											<div class="d-flex flex-column align-items-center align-items-md-start flex-grow-1">
												<h3 class="text-gray-900 fw-boldest text-uppercase mb-5">Kasir</h3>
												<div class="text-gray-800 mb-5 text-center text-md-start">Mulai Penjualan<br /></div>
												<a href="<?=site_url('kasir')?>" class="btn btn-hover-rise text-gray-900 text-uppercase fs-7 fw-bolder" style="background-color: #EBEE51">Transaksi</a>
											</div>
										</div>
									</div>
								</div>
				...
				<div id="kt_sidebar" class="sidebar px-5 py-5 py-lg-8 px-lg-11" data-kt-drawer="true" data-kt-drawer-name="sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="375px" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_sidebar_toggle">
						...
						<div class="ms-1">
							...
							<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px" data-kt-menu="true">
								<div class="menu-item px-3">
									<div class="menu-content fs-6 text-dark fw-bolder px-3 py-4">Filter Notifikasi</div>
								</div>
								<div class="separator mb-3 opacity-75"></div>
								<div class="menu-item px-3">
									<a href="#" class="menu-link px-3">Transaksi</a>
								</div>
								<div class="menu-item px-3">
									<a href="#" class="menu-link px-3">Produk</a>
								</div>
								...
								<div class="menu-item px-3">
									<a href="#" class="menu-link px-3">Pesan</a>
								</div>
							...
							<div class="timeline">
								...
								<div class="timeline-item">
									...
									<div class="timeline-content mb-10 mt-n1">
										...
										<div class="pe-3 mb-5">
											<!--begin::Title-->
											<div class="fs-5 fw-bold mb-2 text-white">Created 2 new tasks in "Development"</div>
											<!--end::Title-->
											<!--begin::Description-->
											<div class="d-flex align-items-center mt-1 fs-6">
												...
												<div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Nina Nilson">
													<img src="<?=base_url('t/')?>media/avatars/150-11.jpg" alt="img" />
												</div>
												<!--end::User-->
											</div>
											<!--end::Description-->
										...
										<div class="pb-5">
											...
											<div class="d-flex flex-stack border rounded px-7 py-3">
												<!--begin::Title-->
												<a href="#" class="fs-5 text-white text-hover-success fw-bold w-375px">Meeting with customer</a>
												<!--end::Title-->
												<!--begin::Action-->
								...
								<div class="timeline-item">
									...
									<div class="timeline-content mb-10 mt-n2">
										...
										<div class="pe-3">
											<!--begin::Title-->
											<div class="fs-5 text-white fw-bold mb-2">2 new entries in "Landing Page"</div>
											<!--end::Title-->
											<!--begin::Description-->
											<div class="d-flex align-items-center mt-1 fs-6">
												<!--begin::Info-->
												...
												<!--end::Info-->
												<a href="#" class="text-success fs-7 fw-bolder">Adam Williams</a>
											</div>
											<!--end::Description-->
										</div>
										<!--end::Timeline heading-->
								...
								<div class="timeline-item">
									...
									<div class="timeline-content mb-10 mt-n1">
										...
										<div class="mb-5 pe-3">
											<!--begin::Title-->
											<a href="#" class="fs-5 fw-bold text-white text-hover-success mb-2">3 New Incoming Project Files</a>
											<!--end::Title-->
											<!--begin::Description-->
											<div class="d-flex align-items-center mt-1 fs-6">
												<!--begin::Info-->
										...
										<div class="pb-5">
											...
											<div class="d-flex flex-stack border rounded p-4 mb-5">
												...
												<div class="d-flex align-items-center me-2">
													<!--begin::Icon-->
													<img alt="" class="w-30px me-3" src="<?=base_url('t/')?>media/svg/files/doc.svg" />
													<!--end::Icon-->
													<!--begin::Info-->
													<div class="d-flex flex-stack">
														...
														<div class="d-flex flex-column me-2">
															<!--begin::Desc-->
															<a href="#" class="fs-7 text-white text-hover-success fw-bolder">App Guidelines</a>
															<!--end::Desc-->
															<!--begin::Number-->
											...
											<div class="d-flex flex-stack border rounded p-4">
												...
												<div class="d-flex align-items-center me-2">
													<!--begin::Icon-->
													<img alt="" class="w-30px me-3" src="<?=base_url('t/')?>media/svg/files/pdf.svg" />
													<!--end::Icon-->
													<!--begin::Info-->
													<div class="d-flex flex-stack">
														<!--begin::Info-->
														<div class="d-flex flex-column me-2">
															<!--begin::Desc-->
															<a href="#" class="fs-7 text-white text-hover-success fw-bolder">Reports</a>
															<!--end::Desc-->
															<!--begin::Number-->
								...
								<div class="timeline-item">
									...
									<div class="timeline-content mb-10 mt-n2">
										...
										<div class="pe-3">
											<!--begin::Title-->
											<div class="fs-5 text-white fw-bold mb-2">2 new notifications received</div>
											<!--end::Title-->
											<!--begin::Description-->
											<div class="d-flex align-items-center mt-1 fs-6">
												<!--begin::Info-->
												...
												<!--end::Info-->
												<a href="#" class="text-success fs-7 fw-bolder">Marcus Fold</a>
											</div>
											<!--end::Description-->
										</div>
										<!--end::Timeline heading-->
								...
								<div class="timeline-item">
									...
									<div class="timeline-content mb-10 mt-n1">
										...
										<div class="mb-5 pe-3">
											<!--begin::Title-->
											<a href="#" class="fs-5 fw-bold text-white text-hover-success mb-2">You have received a payment</a>
											<!--end::Title-->
											<!--begin::Description-->
											<div class="d-flex align-items-center mt-1 fs-6">
												<!--begin::Info-->
											...
											<div class="d-flex flex-stack border rounded p-4">
												...
												<div class="d-flex align-items-center me-2">
													...
													<div class="d-flex flex-stack">
														...
														<div class="d-flex flex-column me-2">
															<!--begin::Desc-->
															<a href="#" class="fs-7 text-white text-hover-success fw-bolder">Withdrawing Funds</a>
															<!--end::Desc-->
															<!--begin::Number-->
								...
								<div class="timeline-item">
									...
									<div class="timeline-content mt-n1">
										...
										<div class="pe-3">
											<!--begin::Title-->
											<div class="fs-5 text-white fw-bold mb-2">2 new entries in UI Design”</div>
											<!--end::Title-->
											<!--begin::Description-->
											<div class="d-flex align-items-center mt-1 fs-6">
												<!--begin::Info-->
							...
							<script>
							    $(document).ready(function(){
    							    async function waitNotification() {
                                        let data = await $.post("notif/check/<?=$_SESSION['usertoken']?>").done(function(data){
                                            var y = JSON.parse(data);
                                            if(y.status==true){
                                                waitNotification();
                                                $("#timeline").prepend(y.html);
                                            }
                                            // setelah terima respon → panggil lagi
                                            
                                        });
                                    }
                                    $.post("notif/welcome/<?=$_SESSION['usertoken']?>").done(function(data){
                                        var y = JSON.parse(data);
                                        if(y.status==true){
                                            $("#timeline").html(y.html);
                                        }
                                        setTimeout(waitNotification,10000);
                                    })
							    })
					...
					<div class="text-center" id="kt_sidebar_footer">
						<a href="../../demo10/dist/pages/profile/activity.html" class="btn btn-hover-rise text-white bg-white bg-opacity-10 text-uppercase fs-7 fw-bolder">View Updates</a>
					</div>
				</div>
			</div>
			<?php include('mod/product_mod.php'); include('mod/pelanggan_mod.php'); ?>
		</div>
		<!--end::Main-->
		<script>var hostUrl = "assets/";</script>
		<!--begin::Javascript-->
		<!--begin::Page Vendors Javascript(used by this page)-->
		<script src="<?=base_url('t/')?>plugins/custom/fullcalendar/fullcalendar.bundle.js"></script>
