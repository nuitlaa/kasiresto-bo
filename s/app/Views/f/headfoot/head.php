<?php $db = db_connect();
	...
	if ($_SESSION['userty']=='owner') {
		$compani = $db->table('account_company')->where(['owner'=>$userid])->get()->getRowArray();
	} else {
		$compani = $db->table('account_company a')->join('account_store_privilage b','b.company=a.id')->where(['b.account'=>$userid])->select('a.*')->get()->getRowArray();
	}
											...
											<div class="menu-item px-5" data-kt-menu-trigger="hover" data-kt-menu-placement="right-end">
												...
												<div class="menu-sub menu-sub-dropdown w-175px py-4"> 
													<div class="menu-item px-3 <?=isset($subsubmenu)&&$subsubmenu=='produk_list'?'active':''?>">
														<a href="<?=site_url('produk/list')?>" class="menu-link px-5">Daftar Produk</a>
													</div> 
													...
													<div class="menu-item px-3 <?=isset($subsubmenu)&&$subsubmenu=='produk_stok'?'active':''?>">
														<a href="<?=site_url('produk/stok')?>" class="menu-link px-5">Stok Produk</a>
													</div> 
